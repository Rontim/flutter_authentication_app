...
const String tWelcomeSubTitle =
    'Welcome to my authentication app built with Flutter.';

/* - Login Screen Text Strings -- */
const String tLoginTitle = 'Login';
const String tLoginSubTitle = 'Enter your credentials to login';
const String tLoginEmail = 'Email';
const String tLoginPassword = 'Password';
const String tLoginForgotPassword = 'Forgot Password?';
const String tLoginButton = 'Login';
const String tLoginDontHaveAccount = "Don't have an account? ";
const String tLoginSignUp = 'Sign Up';

/* - Sign Up Screen Text Strings -- */
const String tSignUpTitle = 'Sign Up';
const String tSignUpSubTitle =
    'Get started with your account now \n& enjoy our services.';
const String tSignUpName = 'Full Name';
const String tSignUpEmail = 'Email';
const String tSignUpPassword = 'Password';
...
const String tForgotPasswordEmail = 'Reset via Email Address.';
const String tForgotPasswordPhone = 'Reset via Phone Number.';
